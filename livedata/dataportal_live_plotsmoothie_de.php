...
<div class="hover3d-image"><img src="images/fotos/Inst_Supergrad.jpg" alt="" /></div>
</div>
</div>
Dieser Kalium-Sensor des Supergradiometers, welches von GEM Systems hergestellt wurde, misst die absolute Stärke des Erdmagnetfelds. Es ist das empfindlichste Messgerät dieser Art weltweit. Für die Analyse werden Gradienten zwischen mehreren Sensoren verwendet.
...
Geomagnetische Daten dienen unter Anderem dazu Weltraumwetter Effekte zu erfassen. Die Hauptursache für Weltraumerwetter-Prozesse werden durch die Sonne und Wechselwirkungen mit dem Erdmagnetfeld verursacht. Eine Live-Aufnamhe der Sonne (EIT 304 vom SOHO Satelitten, ESA/NASA) ist hier dargestellt.
